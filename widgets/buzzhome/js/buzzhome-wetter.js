    ...
    setIconPath: function (iconKey) {
        ...
        switch (iconKey) {
            ...
            case "partlysunny": //done
                ...
                break;
            case "rain": //done
                iconPath = "M22,19.836C22,23.24,19.202,26,15.75,26c-2.135,0-4.018-1.058-5.146-2.669C9.657,23.757,8.609,24,7.5,24C3.358,24,0,20.688,0,16.603C0,12.518,7.477,0,7.477,0s2.473,4.117,4.584,8.399c-0.373,0.682-0.768,1.426-1.164,2.198C9.904,8.481,8.678,6.139,7.483,4.001C4.821,8.791,2,14.61,2,16.603C2,19.579,4.467,22,7.5,22c0.799,0,1.558-0.172,2.244-0.474C9.588,20.988,9.5,20.423,9.5,19.836c0-1.889,1.918-5.941,3.626-9.174c0-0.001,0.001-0.002,0.001-0.002l0,0C14.497,8.067,15.731,6,15.731,6S22,16.432,22,19.836z";
                break;
            case "sleet":
                ...
                break;
            case "snow": //done
                iconPath = "M23.565,15.003l-3.139,0.832l2.25,1.299l-1,1.732l-2.25-1.299l0.849,3.135l-1.93,0.523L16.97,16.15l-3.321-1.917l0.134,1.232l-1-0.732v3.835l3.709,3.728l-1.418,1.41l-2.291-2.303V24h-2v-2.597l-2.291,2.303l-1.418-1.41l3.709-3.728v-3.835l-1,0.732l0.134-1.232L6.596,16.15l-1.374,5.076l-1.931-0.523l0.849-3.135l-2.249,1.299l-1-1.732l2.25-1.299L0,15.003l0.513-1.934l5.084,1.348l3.32-1.917L7.783,12l1.134-0.5L5.596,9.583l-5.083,1.348L0,8.997l3.14-0.832L0.891,6.866l1-1.732L4.14,6.432L3.291,3.297l1.931-0.522l1.374,5.076l3.32,1.917L9.783,8.536l1,0.732V5.434L7.074,1.705l1.418-1.41l2.291,2.303V0h2v2.598l2.291-2.303l1.418,1.41l-3.709,3.729v3.834l1-0.732l-0.134,1.232l3.321-1.917l1.374-5.076l1.93,0.522l-0.849,3.136l2.251-1.299l1,1.732l-2.249,1.299l3.139,0.832l-0.512,1.934L17.97,9.583L14.649,11.5l1.134,0.5l-1.134,0.5l3.321,1.917l5.084-1.348L23.565,15.003";
                break;
            case "sunny": //done
                iconPath = "M17.795,13.537c-0.273,1.033-0.809,1.959-1.541,2.695l4.254,4.231c-0.742,0.745-1.576,1.39-2.479,1.915l-3.016-5.192c-0.881,0.513-1.902,0.813-2.995,0.815l0.016,6.002c-1.026,0.002-2.068-0.126-3.107-0.401l1.539-5.805c-1.033-0.273-1.959-0.809-2.695-1.541l-4.231,4.254c-0.745-0.742-1.39-1.576-1.915-2.479l5.192-3.016c-0.513-0.881-0.813-1.902-0.815-2.995L0,12.033c-0.002-1.026,0.126-2.068,0.401-3.107l5.805,1.539C6.48,9.432,7.016,8.505,7.747,7.77L3.494,3.539c0.742-0.745,1.576-1.39,2.479-1.915l3.016,5.192c0.881-0.513,1.902-0.813,2.995-0.815L11.968,0c1.026-0.002,2.068,0.126,3.107,0.401l-1.539,5.805c1.033,0.273,1.96,0.809,2.695,1.541l4.231-4.253c0.745,0.742,1.39,1.576,1.915,2.479l-5.192,3.016c0.513,0.881,0.813,1.903,0.815,2.995l6.002-0.016c0.002,1.026-0.126,2.068-0.401,3.107L17.795,13.537z";
                break;
            case "tstorms": //done
                iconPath = "M7,11h5L3,26l2-11H0L9,0L7,11z";
                break;
